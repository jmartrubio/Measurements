...
function [fd,err]=savevtkWithVarI(x,y,vx,vy,vz,ur,VarName,var1,var2)
...
fprintf(fd,'SCALARS var1 double\n');
...
fprintf(fd,'\n');
fprintf(fd,'SCALARS var2 double\n');
fprintf(fd,'LOOKUP_TABLE default\n');
for i_f=1:nfvx
  for i_c=1:ncvx
    fprintf(fd,'%f\n',var2(i_f,i_c));  
